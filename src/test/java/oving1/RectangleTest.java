...
public class RectangleTest {
     ...
     */
    static void assertValues(Rectangle rect, int minX, int minY, int maxX, int maxY, int width,
    ...
    private void testAdd(Rectangle rect, int x, int y, boolean expected) {
        ...
        Assertions.assertFalse(rect.isEmpty(),
                "Rectangle should not be empty after adding a point!");
    ...
    public void testAddSameXY() {
        ...
        assertValues(rect, minX1X2X3, minY1Y2Y3, maxX1X2X3, maxY1Y2Y3, maxX1X2X3 - minX1X2X3,
                maxY1Y2Y3 - minY1Y2Y3, "when adding point that is in rectangle");
    ...
    public void testAddRectangle() {
        ...
        // correct.
        Rectangle rect = new Rectangle(x1, y1, x2, y2);
        assertValues(rect, minX1X2, minY1Y2, maxX1X2, maxY1Y2, maxX1X2 - minX1X2, maxY1Y2 - minY1Y2,
        ...
        assertValues(rect2, minX1X3, minY1Y3, maxX1X3, maxY1Y3, maxX1X3 - minX1X3,
    ...
    public void testUnion() {
        ...
        assertValues(rect1, minX1X2, minY1Y2, maxX1X2, maxY1Y2, maxX1X2 - minX1X2,
                maxY1Y2 - minY1Y2, "when creating new rectangle");

        Rectangle rect2 = new Rectangle(x3, y3, x4, y4);
        assertValues(rect2, minX3X4, minY3Y4, maxX3X4, maxY3Y4, maxX3X4 - minX3X4,
